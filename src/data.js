const myData = {
  ...
  projects: [
    {
      id: 1,
      title: "GIF Getter App",
      technologies: ["React", "The Giffy API"],
      description:
        "A web app that allows the user to search GIFs and add them to their favorites.",
      url: "https://gif-getter-app.herokuapp.com",
      github: "https://github.com/jeff-gosselin/gif-app",
